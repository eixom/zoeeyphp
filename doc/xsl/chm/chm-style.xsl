...
<!--    <xsl:param name="htmlhelp.show.advanced.search" select="1"/>-->
    ...
    <xsl:param name="htmlhelp.chm">zoeeyphp.chm</xsl:param>
...
<!--
    ...
    <xsl:param name="highlight.xslthl.config">file:///D:/Project/Netbeans/Java/ZoeeyPHP/docs/temp/docbook-xsl/highlighting/xslthl-config.xml</xsl:param>

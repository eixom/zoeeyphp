...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- Use nice graphics for admonitions -->
    ...
    <xsl:param name="admon.graphics.path">docs/books/zoeeyphp/images/</xsl:param>
    <xsl:param name="draft.watermark.image" select="'docs/books/zoeeyphp/images/draft.png'"/>
